...
(function (S, undefined) {
    ...
    S['isEmail'] = function( email ){
        var emailRegex = /^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,6}$/i;
        return emailRegex.test(email);
    };

    S['isNumeric']  = function(str) {
        var decimalRegex = /^\-?[0-9]*\.?[0-9]+$/;
        return decimalRegex.test(str);
    };

    S['toText'] = function( str ){
    ...
    S['date'] = (function () {
        ...
        var strToTime = function (str) {
            return moment(str, ['YYYY-MM-DD HH:mm:ss' , 'YYYY-MM-DD']).valueOf();
        };

        var timeToStr = function (time, form) {
            form = form.replace('Y-m-d', 'YYYY-MM-DD');
            form = form.replace('H:i:s', 'HH:mm:ss');
